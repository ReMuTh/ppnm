// RENE 2022-05-16 additions to course matrix class
using System;
...
public partial class matrix{
	...
	public bool is_diagonal(double acc=1e-6, double eps=1e-6) {
		return is_upper_triangular(acc,eps) && is_lower_triangular(acc,eps);
	}

	// diagonal function can both return diagonal and define diagonal
